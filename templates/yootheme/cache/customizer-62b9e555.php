<?php // @file /datos/hypertext/plantilla.uniandes.edu.co/Yard/templates/yootheme/vendor/yootheme/theme/config/customizer.json

return [
  '@import' => [$this->applyFilter('../../builder/config/customizer.json', ['path']), $this->applyFilter('../../styler/config/customizer.json', ['path']), $this->applyFilter('../../theme-cookie/config/customizer.json', ['path']), $this->applyFilter('../../theme-settings/config/customizer.json', ['path'])], 
  'base' => $this->get('.theme.base'), 
  'name' => $this->get('.theme.name'), 
  'version' => $this->get('.theme.options.version'), 
  ...
  'sections' => [
    'layout' => [
      'title' => 'Layout', 
      'priority' => 10, 
      'help' => $this->get('theme.help_layout'), 
      'fields' => [
        'layout' => [
          'type' => 'menu', 
          'items' => [
  ...
  'panels' => [
    'site' => [
      ...
      'help' => [
        'Site' => [[
            'title' => 'Logo', 
            'src' => "site/docs/yootheme-pro/site-and-logo/{$this->get('app.platform')}/videos/logo.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/site-and-logo#logo", 
            'support' => 'support/search?tags=125&q=logo'
          ], [
            'title' => 'Layout', 
            'src' => "site/docs/yootheme-pro/site-and-logo/{$this->get('app.platform')}/videos/layout.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/site-and-logo#layout", 
            'support' => 'support/search?tags=125&q=site%20layout'
          ], [
            'title' => 'Toolbar', 
            'src' => "site/docs/yootheme-pro/site-and-logo/{$this->get('app.platform')}/videos/toolbar.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/site-and-logo#toolbar", 
            'support' => 'support/search?tags=125&q=toolbar'
          ], [
            'title' => 'Breadcrumbs', 
            'src' => "site/docs/yootheme-pro/site-and-logo/{$this->get('app.platform')}/videos/breadcrumbs.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/site-and-logo#breadcrumbs", 
            'support' => 'support/search?tags=125&q=breadcrumbs'
          ]], 
        'Image Field' => [[
            'title' => 'Images', 
            'src' => "site/docs/yootheme-pro/files-and-images/{$this->get('app.platform')}/videos/images.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/files-and-images#images", 
            'support' => 'support/search?tags=125&q=image%20field'
          ], [
            'title' => 'Media Manager', 
            'src' => "site/docs/yootheme-pro/files-and-images/{$this->get('app.platform')}/videos/media-manager.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/files-and-images#media-manager", 
            'support' => 'support/search?tags=125&q=media%20manager'
          ], [
            'title' => 'Unsplash Library', 
            'src' => "site/docs/yootheme-pro/files-and-images/{$this->get('app.platform')}/videos/unsplash.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/files-and-images#unsplash-library", 
    ...
    'header' => [
      ...
      'help' => [[
          'title' => 'Header Layout', 
          'src' => "site/docs/yootheme-pro/header-and-navbar/{$this->get('app.platform')}/videos/layout.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/header-and-navbar#header-layout", 
          'support' => 'support/search?tags=125&q=header%20layout'
        ], [
          'title' => 'Navbar', 
          'src' => "site/docs/yootheme-pro/header-and-navbar/{$this->get('app.platform')}/videos/navbar.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/header-and-navbar#navbar", 
          'support' => 'support/search?tags=125&q=navbar'
        ], [
          'title' => 'Navbar Subtitles', 
          'src' => "site/docs/yootheme-pro/header-and-navbar/{$this->get('app.platform')}/videos/navbar-subtitles.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/header-and-navbar#subtitles", 
          'support' => 'support/search?tags=125&q=navbar%20subtitles'
        ], [
          'title' => 'Dropdown Layout', 
          'src' => "site/docs/yootheme-pro/header-and-navbar/{$this->get('app.platform')}/videos/layout-dropdown.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/header-and-navbar#dropdown-layout", 
          'support' => 'support/search?tags=125&q=navbar%20dropdown%20layout'
        ], [
          'title' => 'Offcanvas Layout', 
          'src' => "site/docs/yootheme-pro/header-and-navbar/{$this->get('app.platform')}/videos/layout-offcanvas.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/header-and-navbar#offcanvas-layout", 
          'support' => 'support/search?tags=125&q=navbar%20offcanvas%20layout'
        ], [
          'title' => 'Modal Layout', 
          'src' => "site/docs/yootheme-pro/header-and-navbar/{$this->get('app.platform')}/videos/layout-modal.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/header-and-navbar#modal-layout", 
          'support' => 'support/search?tags=125&q=navbar%20modal%20layout'
        ], [
          'title' => 'Search', 
          'src' => "site/docs/yootheme-pro/header-and-navbar/{$this->get('app.platform')}/videos/search.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/header-and-navbar#search", 
          'support' => 'support/search?tags=125&q=header%20search'
        ], [
          'title' => 'Social Icons', 
          'src' => "site/docs/yootheme-pro/header-and-navbar/{$this->get('app.platform')}/videos/social-icons.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/header-and-navbar#social-icons", 
    ...
    'mobile' => [
      ...
      'help' => [[
          'title' => 'Breakpoint', 
          'src' => "site/docs/yootheme-pro/mobile-header/{$this->get('app.platform')}/videos/breakpoint.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/mobile-header#breakpoint", 
          'support' => 'support/search?tags=125&q=mobile%20header%20breakpoint'
        ], [
          'title' => 'Navbar', 
          'src' => "site/docs/yootheme-pro/mobile-header/{$this->get('app.platform')}/videos/navbar.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/mobile-header#navbar", 
          'support' => 'support/search?tags=125&q=mobile%20header%20navbar'
        ], [
          'title' => 'Logo and Menu Toggle', 
          'src' => "site/docs/yootheme-pro/mobile-header/{$this->get('app.platform')}/videos/logo-and-menu-toggle.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/mobile-header#logo-and-menu-toggle", 
          'support' => 'support/search?tags=125&q=mobile%20header%20logo'
        ], [
          'title' => 'Menu Style', 
          'src' => "site/docs/yootheme-pro/mobile-header/{$this->get('app.platform')}/videos/menu-style.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/mobile-header#menu-style", 
          'support' => 'support/search?tags=125&q=mobile%20header%20menu%20style'
        ], [
          'title' => 'Offcanvas Menu', 
          'src' => "site/docs/yootheme-pro/mobile-header/{$this->get('app.platform')}/videos/menu-animation-offcanvas.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/mobile-header#offcanvas", 
          'support' => 'support/search?tags=125&q=mobile%20header%20offcanvas'
        ], [
          'title' => 'Modal Menu', 
          'src' => "site/docs/yootheme-pro/mobile-header/{$this->get('app.platform')}/videos/menu-animation-modal.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/mobile-header#modal", 
          'support' => 'support/search?tags=125&q=mobile%20header%20modal'
        ], [
          'title' => 'Dropdown Menu', 
          'src' => "site/docs/yootheme-pro/mobile-header/{$this->get('app.platform')}/videos/menu-animation-dropdown.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/mobile-header#dropdown", 
    ...
    'top' => [
      ...
      'help' => [
        'Top and Bottom' => [[
            ...
            'src' => "site/docs/yootheme-pro/top-bottom-and-sidebar/{$this->get('app.platform')}/videos/top-and-bottom.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/top-bottom-and-sidebar#top-and-bottom", 
    ...
    'sidebar' => [
      ...
      'help' => [
        'Sidebar' => [[
            'title' => 'Sidebar', 
            'src' => "site/docs/yootheme-pro/top-bottom-and-sidebar/{$this->get('app.platform')}/videos/sidebar.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/top-bottom-and-sidebar#sidebar", 
    ...
    'footer-builder' => [
      ...
      'help' => [
        'Footer Builder' => [[
            ...
            'src' => "site/docs/yootheme-pro/footer-builder/{$this->get('app.platform')}/videos/footer-builder.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/footer-builder", 
            'support' => 'support/search?tags=125&q=footer%20builder'
          ], [
            'title' => 'Advanced Layouts', 
            'src' => "site/docs/yootheme-pro/builder-widget-and-module/{$this->get('app.platform')}/videos/advanced-layouts.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/builder-widget-and-module#advanced-layouts", 
        ...
        'Image Field' => [[
            ...
            'title' => 'Links', 
            'src' => "site/docs/yootheme-pro/files-and-images/{$this->get('app.platform')}/videos/links.mp4", 
            'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/files-and-images#links", 
