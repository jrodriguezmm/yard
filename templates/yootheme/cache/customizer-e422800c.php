<?php // @file /datos/hypertext/plantilla.uniandes.edu.co/Yard/templates/yootheme/vendor/yootheme/theme-joomla-modules/config/customizer.json
...
return [
  'sections' => [
    'joomla-modules' => [
      'title' => 'Modules', 
      'priority' => 40, 
      'url' => "administrator/index.php?option={$this->get('.component')}", 
      'help' => [
        ...
        'Builder Module' => [[
            'title' => 'Open the Builder Module', 
            'src' => 'site/docs/yootheme-pro/builder-widget-and-module/joomla/videos/open-builder-module.mp4', 
            'documentation' => 'support/yootheme-pro/joomla/builder-widget-and-module', 
            'support' => 'support/search?tags=125&q=builder%20module'
          ], [
            'title' => 'Advanced Layouts', 
            'src' => 'site/docs/yootheme-pro/builder-widget-and-module/joomla/videos/advanced-layouts.mp4', 
            'documentation' => 'support/yootheme-pro/joomla/builder-widget-and-module#advanced-layouts', 
            'support' => 'support/search?tags=125&q=builder%20module'
          ]]
      ]
    ]
