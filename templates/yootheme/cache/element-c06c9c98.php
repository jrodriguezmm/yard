<?php // @file /datos/hypertext/plantilla.uniandes.edu.co/Yard/templates/yootheme/vendor/yootheme/builder/elements/grid/element.json
...
return [
  ...
  'fields' => [
    ...
    'title_hover_style' => [
      ...
      'enable' => 'show_title && (title_display != \'lightbox\' && lightbox || !lightbox) && show_link && link_type'
    ], 
    'title_decoration' => [
      'label' => 'Decoration', 
    ...
    'image_transition' => [
      ...
      'enable' => 'show_image && show_link && link_type'
    ], 
    'image_border' => [
      'label' => 'Border', 
    ...
    'image_hover_box_shadow' => [
      ...
      'enable' => 'show_link && show_image && !panel_style && link_type'
    ], 
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['grid_masonry', 'grid_parallax', 'grid_column_gap', 'grid_row_gap', 'grid_divider']
            ], [
              'label' => 'Columns', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['filter', 'filter_style', 'filter_all', 'filter_all_label', 'filter_position', 'filter_style_primary', 'filter_align', 'filter_margin', 'filter_grid_width', 'filter_grid_column_gap', 'filter_grid_row_gap', 'filter_grid_breakpoint']
            ], [
              'label' => 'Lightbox', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['title_style', 'title_hover_style', 'title_decoration', 'title_font_family', 'title_color', 'title_element', 'title_align', 'title_grid_width', 'title_grid_column_gap', 'title_grid_row_gap', 'title_grid_breakpoint', 'title_margin']
            ], [
              'label' => 'Meta', 
              'type' => 'group', 
              'divider' => true, 
