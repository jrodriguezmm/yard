<?php // @file /datos/hypertext/plantilla.uniandes.edu.co/Yard/templates/yootheme/vendor/yootheme/builder/elements/column/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      'fields' => ['vertical_align', 'style', 'image', '_media', 'preserve_color', 'text_color', 'padding', 'css']
    ]
  ], 
  'panels' => [
      ...
      'fieldset' => [
        'default' => [
          'fields' => [[
            ...
            ], 'image_parallax_easing', 'image_parallax_breakpoint', 'image_visibility', 'media_background', 'media_blend_mode', 'media_overlay']
        ]
      ]
    ]
  ]
