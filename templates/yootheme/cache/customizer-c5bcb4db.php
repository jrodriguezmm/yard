<?php // @file /datos/hypertext/plantilla.uniandes.edu.co/Yard/templates/yootheme/vendor/yootheme/theme-settings/config/customizer.json
...
return [
  'sections' => [
    'settings' => [
      'title' => 'Settings', 
      'priority' => 60, 
      'help' => $this->get('theme.help_settings'), 
      'fields' => [
        'settings' => [
          'type' => 'menu', 
          'items' => [
  ...
  'panels' => [
    ...
    'advanced' => [
      ...
      'help' => [[
          'title' => 'Lazy Loading', 
          'src' => "site/docs/yootheme-pro/settings/{$this->get('app.platform')}/videos/lazy-loading.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/settings#lazy-loading", 
          'support' => 'support/search?tags=125&q=lazy%20loading'
        ], [
          'title' => 'Next-Gen Images', 
          'src' => "site/docs/yootheme-pro/settings/{$this->get('app.platform')}/videos/webp.mp4", 
          'documentation' => "support/yootheme-pro/{$this->get('app.platform')}/settings#next-gen-images", 
