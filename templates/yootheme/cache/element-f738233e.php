<?php // @file /datos/hypertext/plantilla.uniandes.edu.co/Yard/templates/yootheme/vendor/yootheme/builder/elements/section/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Settings', 
          'fields' => ['style', 'overlap', 'image', 'video', '_media', 'preserve_color', 'text_color', 'width', 'width_expand', 'height', 'vertical_align', 'padding', 'padding_remove_top', 'padding_remove_bottom', 'header_transparent', 'header_transparent_noplaceholder', 'animation', 'animation_delay', [
              'label' => 'Title', 
              'type' => 'group', 
              'fields' => ['title', 'title_position', 'title_rotation', 'title_breakpoint']
            ]]
