<?php // @file /datos/hypertext/plantilla.uniandes.edu.co/Yard/templates/yootheme/vendor/yootheme/builder/elements/list/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['icon', 'icon_color', 'icon_ratio']
            ], [
              'label' => 'Link', 
              'type' => 'group', 
              'divider' => true, 
